                ...
                <div className="card-body">
                    <form className="row" style={{padding:"20px"}}>
                        <div style={{textAlign:"center"}}>
                            <img src="https://static.vecteezy.com/system/resources/previews/002/275/847/original/male-avatar-profile-icon-of-smiling-caucasian-man-vector.jpg" alt="Avatar" style={{borderRadius:"50%"}}></img>
                        </div>
                        ...
                        <div style={{marginTop:"4px",textAlign:"center"}}>
                            ...
                            <button type="button" id="saveBtn" onClick={saveInfo} className="btn" style={{marginTop:"10px",backgroundColor:"#A2F7BF",color:"black"}}>Save</button>
                        </div>
                    </form>
                </div>
            </div>
