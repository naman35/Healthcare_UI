        ...
        <div style={{backgroundImage:"url('https://images.unsplash.com/photo-1613492636024-9430710a84d4?ixlib=rb-1.2.1&ixid=MnwxMjA3fDB8MHxzZWFyY2h8MXx8b24lMjB0b3AlMjBvZiUyMHRoZSUyMHdvcmxkfGVufDB8fDB8fA%3D%3D&w=1000&q=80')" ,backgroundSize: 'cover',
            ...
            <Grid>
                <Paper elevation={10} style={paperStyle}>
                    ...
                    <Paper><h2>Section-2:Enhance Your Capability</h2></Paper>
                    <br></br>
                    ...
                    <br/><Paper><Button href="/quizmcq?id=2" type="button" ><b>Sub-Section-1:</b>Knowledge Point</Button></Paper><br></br>
                    <Paper><Button href="/quizfillup?id=2" type="button" ><b>Sub-Section-2:</b>Tool Box</Button></Paper><br></br>
                    <Paper><Button href="/quizmcq?id=2" type="button" ><b>Sub-Section-3:</b>Never Have I Ever</Button></Paper><br></br>
                    <Paper><Button href="/quizfillup?id=2" type="button" ><b>Sub-Section-4:</b>Chill Time(Optional)</Button></Paper><br></br>
